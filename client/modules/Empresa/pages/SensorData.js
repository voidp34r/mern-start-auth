...
import { Card, Grid, List, ListItem, Typography, CardActions, CardContent } from '@material-ui/core';
  ...
  render() {
    const BuildGrid = (
      <List>
        <ListItem>
          <Typography>
            Location: {`empresa/${this.props.params.cuid}/sensor/${this.props.params.sensorUid}`}
...
SensorData.need = [() => { return fetchEmpresa(); }];
